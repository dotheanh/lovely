...
export const Nav20DataSource = {
  ...
  logo: {
    className: 'header2-logo kvmm2zaob0g-editor_css',
    children:
      'https://scontent.fsgn8-2.fna.fbcdn.net/v/t39.30808-6/237935115_2033781410107415_7418908367087038463_n.jpg?_nc_cat=100&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=-1NIqwzuh5oAX9fjatf&_nc_ht=scontent.fsgn8-2.fna&oh=1c6eaa54eaed76f5d8f626de345b625f&oe=6189D98F',
  },
  LinkMenu: {
    ...
    children: [
      ...
      {
        name: 'linkNav~kvmm7xaoeth',
        to: '当前页面 ID 地址，参考如上',
        children: 'Feed',
        className: 'menu-item',
      },
      {
        name: 'linkNav~kvmm80hzf0r',
        to: '当前页面 ID 地址，参考如上',
        children: 'Play',
        className: 'menu-item',
      },
  ...
  textWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <span>
            <p>Đỗ Thế Anh x Nguyễn Thị Lan Hương</p>
          </span>
        ),
      },
      {
